export default function BorrowerApplicationsPage() {
  return <ComingSoon title="My Applications" phase={3} description="Track the status of your loan applications, review conditions, and view underwriting decisions." />
}
