...
SQL migration DDL and verification/audit queries for Phase 4 tables.
...
> For Phase 3 tables, see `SQL_Reference_Phase3.md`.
...
1. [Step 1 — Workflow Automation](#1-step-1--workflow-automation)
2. [Step 2 — E-Signatures (Dropbox Sign)](#2-step-2--e-signatures-dropbox-sign)
3. [Step 3 — OCR / Document Intelligence](#3-step-3--ocr--document-intelligence)
4. [Step 4 — Compliance Hardening](#4-step-4--compliance-hardening)
5. [Cross-Phase Verification Queries](#5-cross-phase-verification-queries)
